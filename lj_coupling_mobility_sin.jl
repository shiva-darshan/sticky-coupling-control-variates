...
function main(coupling, L, eta, beta, burn_in_time, T, dt, sampling_interval, seed; save_data = true)
    ...
    if save_data
        save(string(data_dir, "lj_", coupling, "_coupling_distmobilitypressuretilt_sinshear_seed", seed, "_L", L, "_eta", 
        ...
        save(string(state_dir, "lj_", coupling, "_coupling_distmobilitypressuretilt_sinshear_state_seed", seed, "_L", L, "_eta", 
            eta, "_beta", beta, "_T", T, "_dt", dt, "_burn", burn_in_time, "_interval", sampling_interval, 
            ".jld"), "state", state)
    else
